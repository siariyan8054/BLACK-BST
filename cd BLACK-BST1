...
\033[1;91m☞ Auther     :BLACK BST
\033[1;92m☞ WhatsApp   : 01732270293
\033[1;95m☞ YouTube   
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 01732270293✓')
	    psb('WellCome To BLACK BST')
	    psb('Congratulations BLACK BST Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ ARIYAN✓')
	    psb('🔓Password ☆ 123456✓'
